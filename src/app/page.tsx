        ...
        <section className="mt-32 py-6 bg-gray-50">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 p-6 mt-12 lg:mx-20">
            ...
            <CardContent className="flex flex-col items-center">
              ...
              <div className="text-md text-muted-foreground mt-1">Years Experience</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="flex flex-col items-center">
              <div className="font-bold text-2xl lg:text-3xl text-blue-500">50+</div>
              <div className="text-md text-muted-foreground mt-1">Projects Completed</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="flex flex-col items-center">
              <div className="font-bold text-2xl lg:text-3xl text-blue-500">25+</div>
              <div className="text-md text-muted-foreground mt-1">Happy Clients</div>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="flex flex-col items-center">
              <div className="font-bold text-2xl lg:text-3xl text-blue-500">15+</div>
              <div className="text-md text-muted-foreground mt-1">Technologies</div>
            </CardContent>
          </Card>
          </div>
        </section>
